...
@NonNullApi
public class AIFinTrackProjectDependency extends DelegatingProjectDependency {

    @Inject
    public AIFinTrackProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
